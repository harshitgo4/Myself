    ...
    <div className="  bg-green-200 shadow-md sticky top-0 z-50 px-4  scroll-smooth">
      ...
      {isOpen && (
        <div className="mt-4 lg:hidden">
          ...
          <a href='https://drive.google.com/file/d/1IjT0hEtv5Ed7zaePxaP0hN1iz_GYsXbk/view?usp=drive_link' target='_' className="btn mb-2 w-full block" onClick={toggleMenu} >Resume</a>
          </div>
        </div>
      )}
    </div>
